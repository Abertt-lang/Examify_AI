    ...
    <Background>
      <ScrollView 
        ...
        <View style={styles.form}>
          ...
          >
            <View style={[styles.checkbox, esHumano && styles.checkboxChecked]} />
            <Text style={styles.checkboxLabel}>¿Eres un humano?</Text>
          </Pressable>

          <PillButton title="Registrarse" onPress={handleRegister} />
...
const styles = StyleSheet.create({
  ...
  helper: { textAlign: 'center', color: colors.textMuted, marginTop: 14, marginBottom: 4 },
});